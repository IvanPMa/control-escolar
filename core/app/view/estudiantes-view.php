...
<?php elseif(isset($_GET["opt"])&& $_GET["opt"]=="new"):?>
  ...
  <div class="form-group col-md-3">
      ...
      <input type="tex" name="dni" class="form-control" id="inputEmail4" placeholder="Numero de cuenta">
    </div>
    <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-6">
      <label for="inputEmail4">TUTOR(a)</label>
      <input type="text" name="apoderado" class="form-control" id="inputEmail4" placeholder="TUTOR(a)">
    </div>
     <div class="form-group col-md-3">
...
<div class="row">
  ...
  <div class="form-group">
    <div class="form-group col-md-3">      <label for="inputEmail4">Numero de cuenta:</label>
    <input type="tex" value="<?=$estu->dni;?>" name="dni" class="form-control" id="inputEmail4" placeholder="Numero de cuenta">
    </div>
    <div class="form-group col-md-3">
    <label for="inputEmail4">Nombres:</label>
    ...
    <div class="form-group col-md-6">
      <label for="inputEmail4">TUTOR(a)</label>
      <input type="text" value="<?=$estu->apoderado;?>" name="apoderado" class="form-control" id="inputEmail4" placeholder="TUTOR(a)">
    </div>
    <div class="form-group col-md-3">
                <label>Fecha de Nacimiento:</label>
                <div class="input-group">
