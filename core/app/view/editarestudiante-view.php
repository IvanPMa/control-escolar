...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="tex" value="<?=$estudiante->dni;?>" name="dni" class="form-control" id="inputEmail4" placeholder="Numero de cuenta">
    </div>
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" value="<?=$estudiante->apoderado;?>" name="apoderado" class="form-control" id="inputEmail4" placeholder="TUTOR(a)">
    </div>
    <div class="form-group col-md-3">
