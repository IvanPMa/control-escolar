...
<head>
  ...
  <title>Control Escolar | CBT 3 </title>
...
<body class="hold-transition <?php if(isset($_SESSION["user_id"])): ?>skin-green sidebar-mini<?php else:?>login-page<?php endif;?>">
...
<div class="wrapper">
  ...
  <header class="main-header">
   ...
   <a href="./" class="logo">
      ...
      <span class="logo-lg"><b>CBT 3</b> Zumpango</span>
    </a>
 ...
 <!-- <a class="btn btn-primary" href="#"><i class="fa fa-user fa-fw"></i> <?php echo Core::$user->name;?></a> -->
  <a class="btn btn-success" href="#"><i class="fa fa-user fa-fw"></i> <?php echo Core::$user->name;?></a>
...
?>
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Primera version</b> 1.0
    </div>
    <strong>BRIGADA MINICELLS  2020-2021 <a href="http://cbt3zumpango.edu.mx/">Centro de Bachillerato Tecnológico
No. 3, Zumpango</a>.</strong> 
  </footer>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Control Escolar</b>CBT 3</a>
  </div>
  <!-- /.login-logo -->
